[简体中文](README.zh-CN.md) | [English](README.en-US.md) | [About How to get your cookies/如何获得你的cookie](docs/HowToGetUrAuthToken.md)
...
0. 首先 npm i bili-audio-downloader to download, 然后使用bad指令打开
